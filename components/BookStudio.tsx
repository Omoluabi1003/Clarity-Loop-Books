...
export function BookStudio() {
  ...
  const [authMode, setAuthMode] = useState<AuthMode | null>("signin");
  ...
  useEffect(() => {
    const timer = window.setTimeout(() => {
      ...
      setAuthMode(savedSession ? null : savedAccounts.length ? "signin" : "signup");
  ...
  const authenticationRequired = !authUser;
