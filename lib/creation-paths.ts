...
export const CREATION_PATH_CONFIG: Record<CreationPathId, CreationPathConfig> = {
  start_from_idea: {
    ...
    stepOne: { title: "What idea keeps coming back to you?", subtitle: "Give the idea a name, then describe the message, story, or outcome you want to create.", fields: [
      { name: "workingTitle", label: "Working title", placeholder: "e.g. The Courage to Begin", type: "text", required: true, span: "half" },
      { name: "creatorName", label: "Creator or author name", placeholder: "Name shown on the project", type: "text", required: true, span: "half" },
      { name: "originStory", label: "Where did this idea come from?", placeholder: "Describe the moment, problem, lesson, question, or experience that inspired this idea.", type: "textarea", required: true },
      ...
      { name: "readerOrViewerImpact", label: "What should people feel, understand, or do after experiencing it?", placeholder: "Describe the transformation or takeaway.", type: "textarea", required: true },
    ] },
  ...
  nonfiction_book: {
    ...
    stepOne: { title: "What truth, method, or message are you ready to teach?", subtitle: "Nonfiction begins with a clear promise to the reader.", fields: [
      { name: "title", label: "Book title", placeholder: "e.g. The Clarity Loop", type: "text", required: true, span: "half" },
      { name: "subtitle", label: "Subtitle", placeholder: "e.g. Modern Workflows, AI, and Why Understanding Now Comes After Action", type: "text", span: "half" },
      { name: "authorName", label: "Author name", placeholder: "Name shown on the cover and title page", type: "text", required: true },
      { name: "centralThesis", label: "Central thesis", placeholder: "What is the main argument or idea this book will prove?", type: "textarea", required: true },
      { name: "readerProblem", label: "Reader problem", placeholder: "What frustration, confusion, pain, or ambition brings the reader to this book?", type: "textarea", required: true, span: "half" },
      { name: "readerTransformation", label: "Reader transformation", placeholder: "What should the reader understand or become able to do by the end?", type: "textarea", required: true, span: "half" },
      { name: "frameworkOrMethod", label: "Framework, method, or message", placeholder: "Describe the model, process, lessons, or principles the book will organize.", type: "textarea", required: true },
    ] },
  ...
  fiction_book: {
    ...
    stepOne: { title: "What story are you ready to tell?", subtitle: "Fiction begins with a character who wants something and a world that resists them.", fields: [
      { name: "storyTitle", label: "Story title", placeholder: "e.g. The Last Door in Lagos", type: "text", required: true, span: "half" },
      { name: "authorName", label: "Author name", placeholder: "Name shown on the cover", type: "text", required: true, span: "half" },
      { name: "genre", label: "Genre", placeholder: "Drama, romance, thriller, mystery, fantasy, Christian fiction...", type: "text", required: true },
      { name: "mainCharacter", label: "Main character", placeholder: "Who is the story about? What do they believe they need?", type: "textarea", required: true, span: "half" },
      { name: "centralConflict", label: "Central conflict", placeholder: "What do they want, and what stands in their way?", type: "textarea", required: true, span: "half" },
      { name: "setting", label: "Setting and world", placeholder: "Where and when does the story take place? What makes this world distinct?", type: "textarea", required: true, span: "half" },
      { name: "emotionalPromise", label: "Emotional promise", placeholder: "What should readers feel by the end?", type: "textarea", required: true, span: "half" },
    ] },
  ...
  upload_manuscript: {
    ...
    stepOne: { title: "What existing work should we analyze?", subtitle: "Upload a file or provide a link. Clarity Loop will preserve the original and create an improvement report.", fields: [
      { name: "projectTitle", label: "Project title", placeholder: "Name this manuscript project", type: "text", required: true, span: "half" },
      { name: "authorName", label: "Author name", placeholder: "Original author or project owner", type: "text", required: true, span: "half" },
      { name: "uploadFile", label: "Upload manuscript", placeholder: "PDF, DOCX, TXT, Markdown, or EPUB", type: "file", hint: "Accepted for intake: PDF, DOCX, TXT, MD, and EPUB." },
      { name: "sourceLink", label: "Source link", placeholder: "Paste a website, cloud document, or project link", type: "url" },
      { name: "analysisGoal", label: "What should Clarity Loop focus on?", placeholder: "Repetition, structure, clarity, tone, market fit, screenplay potential, publishing readiness...", type: "textarea", required: true },
    ] },
  ...
  screen_adaptation: {
    ...
    stepOne: { title: "What source should become screen content?", subtitle: "Start with the source, then choose the format: film, TV, documentary, stage, or video.", fields: [
      { name: "sourceTitle", label: "Source title", placeholder: "Title of the book, memoir, article, sermon, or report", type: "text", required: true, span: "half" },
      { name: "creatorName", label: "Creator or author name", placeholder: "Name attached to the source material", type: "text", required: true, span: "half" },
      { name: "sourceSummary", label: "Source summary", placeholder: "What is the story, message, or central idea?", type: "textarea", required: true },
      { name: "adaptationFormat", label: "Adaptation format", placeholder: "Feature film, TV pilot, docuseries, documentary, short film, stage play...", type: "text", required: true, span: "half" },
      { name: "screenTone", label: "Screen tone", placeholder: "Cinematic, emotional, educational, suspenseful, inspirational, corporate...", type: "text", required: true, span: "half" },
    ] },
  ...
  publishing_pack: {
    ...
    stepOne: { title: "What book are we preparing to publish?", subtitle: "Bring the book details, then generate cover assets, metadata, description, keywords, and launch copy.", fields: [
      { name: "bookTitle", label: "Book title", placeholder: "Title shown on the publishing listing", type: "text", required: true, span: "half" },
      { name: "subtitle", label: "Subtitle", placeholder: "Optional subtitle", type: "text", span: "half" },
      { name: "authorName", label: "Author name", placeholder: "Name shown on the cover and listing", type: "text", required: true },
      { name: "bookDescription", label: "Book description", placeholder: "Paste the current description or describe the book.", type: "textarea", required: true },
      { name: "publishingPlatform", label: "Publishing platform", placeholder: "Amazon KDP, IngramSpark, EPUB, PDF, audiobook...", type: "text", required: true, span: "half" },
      { name: "launchGoal", label: "Launch goal", placeholder: "Sell, build authority, teach, minister, promote a service, attract speaking opportunities...", type: "textarea", required: true, span: "half" },
    ] },
  ...
  movie_pitch_pack: {
    ...
    stepOne: { title: "What screen concept are we pitching?", subtitle: "Define the premise, audience, format, tone, and why this story deserves to be seen.", fields: [
      { name: "projectTitle", label: "Project title", placeholder: "Title of the film, series, or documentary", type: "text", required: true, span: "half" },
      { name: "creatorName", label: "Creator name", placeholder: "Writer, producer, or owner of the concept", type: "text", required: true, span: "half" },
      { name: "premise", label: "Premise", placeholder: "What is the core story or concept?", type: "textarea", required: true },
      { name: "format", label: "Format", placeholder: "Feature film, limited series, TV pilot, documentary, docuseries...", type: "text", required: true, span: "half" },
      { name: "targetAudience", label: "Target audience", placeholder: "Who would watch this and why?", type: "textarea", required: true, span: "half" },
      { name: "whyNow", label: "Why now?", placeholder: "Why does this story matter in this moment?", type: "textarea", required: true },
    ] },
