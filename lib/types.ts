...
export interface SalesMetricAttribution { sourceType: SalesSourceType; sourceName: string; confidenceLevel: MarketConfidenceLevel; collectedAt: string; verificationStatus: SalesVerificationStatus; sourceUrl?: string; dataPermission?: "user_uploaded" | "official_api" | "partner_export" | "licensed" | "public_terms_checked" | "manual_entry"; }
