...
export const sampleBooks: Book[] = [
  {
    ...
    chapters: [
      ...
      { id: "c3", bookId: "clear-way-forward", chapterNumber: 3, title: "Name What Matters Most", summary: "Use a simple values filter to narrow choices without overthinking.", outline: ["Find the real question", "Choose three guiding values", "Test the options"], actualWordCount: 0, targetWordCount: 2500, estimatedPages: 10, content: "", status: "pending", locked: false },
      { id: "c4", bookId: "clear-way-forward", chapterNumber: 4, title: "Make the Smallest Honest Move", summary: "Turn insight into a low-risk next step readers can use immediately.", outline: ["Shrink the decision", "Design a useful experiment", "Notice what action teaches"], actualWordCount: 0, targetWordCount: 2500, estimatedPages: 10, content: "", status: "pending", locked: false },
      ...
      { id: "c6", bookId: "clear-way-forward", chapterNumber: 6, title: "When the Plan Changes", summary: "Help readers adapt without treating change as failure.", outline: ["Expect new information", "Release the perfect plan", "Adjust with intention"], actualWordCount: 0, targetWordCount: 2400, estimatedPages: 9, content: "", status: "pending", locked: false },
      { id: "c7", bookId: "clear-way-forward", chapterNumber: 7, title: "Build a Clarity Practice", summary: "Turn the framework into a repeatable weekly rhythm.", outline: ["Create a weekly reset", "Keep decisions visible", "Protect thinking time"], actualWordCount: 0, targetWordCount: 2500, estimatedPages: 10, content: "", status: "pending", locked: false },
      { id: "c8", bookId: "clear-way-forward", chapterNumber: 8, title: "The Way Forward Is Made", summary: "Close with confidence, momentum, and an invitation to begin.", outline: ["Gather what changed", "Name the next season", "Make the next honest move"], actualWordCount: 0, targetWordCount: 2200, estimatedPages: 8, content: "", status: "pending", locked: false },
    ],
  },
];
