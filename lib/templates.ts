...
export const sampleBooks: Book[] = [
  {
    ...
    authorBio: "Jordan Ellis writes practical guides for thoughtful professionals.",
    ...
    wordsPerPage: 275,
    targetWords: 49500,
    averageWordsPerChapter: 6188,
    actualWords: 0,
    actualEstimatedPages: 0,
    ...
    color: "midnight",
    coverPrompt: "Professional cover with a clear path emerging from fog, sophisticated typography, by Jordan Ellis.",
    versionHistory: [],
    bookDna: {
    ...
    chapters: [
      { id: "c1", bookId: "clear-way-forward", chapterNumber: 1, openingStyle: "scenario", qualityFlags: [], title: "When the Path Feels Foggy", summary: "Name the emotional cost of uncertainty and show why clarity is a practice.", outline: ["The hidden weight of open decisions", "Why certainty is the wrong goal", "A gentler definition of clarity"], actualWordCount: 0, targetWordCount: 2400, estimatedPages: 9, content: "There is a particular kind of tiredness that comes from carrying a decision you have not made. It follows you from room to room, quietly asking for attention.\n\nMost of us assume clarity arrives like a flash of light. In practice, it is more often built through a series of small, honest questions. The goal is not to see the entire road. It is to see enough of the next step to begin.", status: "locked", locked: true },
      { id: "c2", bookId: "clear-way-forward", chapterNumber: 2, openingStyle: "question", qualityFlags: [], title: "The Noise Around the Decision", summary: "Separate personal priorities from outside expectations, urgency, and fear.", outline: ["Recognize borrowed urgency", "Separate advice from alignment", "Create a quiet decision space"], actualWordCount: 0, targetWordCount: 2600, estimatedPages: 10, content: "", status: "pending", locked: false },
      { id: "c3", bookId: "clear-way-forward", chapterNumber: 3, openingStyle: "direct_claim", qualityFlags: [], title: "Name What Matters Most", summary: "Use a simple values filter to narrow choices without overthinking.", outline: ["Find the real question", "Choose three guiding values", "Test the options"], actualWordCount: 0, targetWordCount: 2500, estimatedPages: 10, content: "", status: "pending", locked: false },
      { id: "c4", bookId: "clear-way-forward", chapterNumber: 4, openingStyle: "contrast", qualityFlags: [], title: "Make the Smallest Honest Move", summary: "Turn insight into a low-risk next step readers can use immediately.", outline: ["Shrink the decision", "Design a useful experiment", "Notice what action teaches"], actualWordCount: 0, targetWordCount: 2500, estimatedPages: 10, content: "", status: "pending", locked: false },
      { id: "c5", bookId: "clear-way-forward", chapterNumber: 5, openingStyle: "observation", qualityFlags: [], title: "Trust the Evidence You Create", summary: "Show how action rebuilds trust in personal judgment.", outline: ["Build evidence through action", "Read outcomes without shame", "Strengthen self-trust"], actualWordCount: 0, targetWordCount: 2500, estimatedPages: 10, content: "", status: "pending", locked: false },
      { id: "c6", bookId: "clear-way-forward", chapterNumber: 6, openingStyle: "case_example", qualityFlags: [], title: "When the Plan Changes", summary: "Help readers adapt without treating change as failure.", outline: ["Expect new information", "Release the perfect plan", "Adjust with intention"], actualWordCount: 0, targetWordCount: 2400, estimatedPages: 9, content: "", status: "pending", locked: false },
      { id: "c7", bookId: "clear-way-forward", chapterNumber: 7, openingStyle: "problem_statement", qualityFlags: [], title: "Build a Clarity Practice", summary: "Turn the framework into a repeatable weekly rhythm.", outline: ["Create a weekly reset", "Keep decisions visible", "Protect thinking time"], actualWordCount: 0, targetWordCount: 2500, estimatedPages: 10, content: "", status: "pending", locked: false },
      { id: "c8", bookId: "clear-way-forward", chapterNumber: 8, openingStyle: "scenario", qualityFlags: [], title: "The Way Forward Is Made", summary: "Close with confidence, momentum, and an invitation to begin.", outline: ["Gather what changed", "Name the next season", "Make the next honest move"], actualWordCount: 0, targetWordCount: 2200, estimatedPages: 8, content: "", status: "pending", locked: false },
    ],
  },
];
