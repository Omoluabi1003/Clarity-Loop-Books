...
export const STUDIO_MODULES: { id: string; title: string; eyebrow: string; description: string; outputs: string[]; projectTypes: ProjectType[] }[] = [
  ...
  { id: "author_success_hub", title: "Author Success Hub", eyebrow: "FROM IDEA TO INCOME", description: "Position, launch, market, and extend your finished book with a practical post-book operating plan.", outputs: ["Marketability score", "Reader DNA", "Launch plan", "Revenue paths"], projectTypes: ["idea", "nonfiction", "fiction", "upload", "publishing_pack"] },
];
